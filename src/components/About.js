...
//             <div className="accordion-body" style={myStyle}>
//               <ul>
//                 <li>Browse news by category like Politics, Business, Tech, Sports, and more.</li>
//                 <li>Real-time updates from trusted global sources.</li>
//                 <li>Simple and responsive UI for seamless reading.</li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
//             <div className="accordion-body" style={myStyle}>
//               <ul>
//                 <li>Reliable API ensuring accurate and up-to-date content.</li>
//                 <li>Supports multiple countries and news categories.</li>
//                 <li>Fast and secure integration for a smooth experience.</li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
//             <div className="accordion-body" style={myStyle}>
//               <ul>
//                 <li>Switch between light and dark themes effortlessly.</li>
//                 <li>Theme applies across the entire NewsNova application.</li>
//                 <li>Improves readability and user experience based on preference.</li>
//               </ul>
//             </div>
//           </div>
//         </div>
